...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        Log.d(TAG, "Camera resolution: " + screenResolution.x + screenResolution.y);
    }

    void setDesiredCameraParameters(Camera camera) {
        Camera.Parameters parameters = camera.getParameters();
        parameters.setPreviewSize(cameraResolution.x, cameraResolution.y);
        parameters.setPreviewFormat(IMAGE_FORMAT); // setting preview format：YV12  PIXEL_FORMAT_YUV420P
    ...
    private static Point findBestPreviewSizeValue(List<Camera.Size> previewSizes, Point screenResolution) {
        int bestX = 0;
        int bestY = 0;
